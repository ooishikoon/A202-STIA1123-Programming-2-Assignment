...
public class Sales {		//2.1 Inheritance
							//2.4 Abstraction
	...
	public double calculateTotalPrice() {	//1.4 constructor with no argument
		return totalPrice = price * dayToRent;
	}
	
	public double calculateTotalPrice(double p2) {	//1.4 constructor with one argument
		return totalPrice = p2 * dayToRent;
	}
	
	public double calculateTotalPrice(double p3, int d) {	//1.4 constructor with two argument
